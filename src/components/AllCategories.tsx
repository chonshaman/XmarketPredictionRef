            ...
            {filterOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  className="font-sans transition-all duration-200 cursor-pointer"
                  style={{
                    fontSize: 'var(--text-sm)',
                    fontWeight: 'var(--font-weight-medium)',
                    ...
                    height: '32px',
                    backgroundColor: isActive ? 'var(--iris-9)' : hoveredFilter === option ? 'var(--iris-9)' : 'var(--side-bar-outline)',
                    color: isActive ? '#FFFFFF' : hoveredFilter === option ? '#FFFFFF' : 'var(--muted-foreground)',
                    border: `1px solid ${isActive ? 'var(--iris-9)' : 'var(--black-a2)'}`,
                    borderRadius: '9999px',
                  }}
                  onMouseEnter={() => setHoveredFilter(option)}
