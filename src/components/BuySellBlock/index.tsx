...
export function BuySellBlock({ 
  ...
  // Dynamic border radius for tab transition
  const cardBorderRadius = activeTab === 'Sell' ? 'rounded-tl-[16px]' : 'rounded-tl-none';
  ...
  return (
    <div className="content-stretch flex flex-col isolate items-start relative w-full" data-name="buy sell block">
      ...
      <div 
        className={`w-full relative rounded-bl-[12px] rounded-br-[12px] rounded-tr-[12px] ${cardBorderRadius} shrink-0 z-[1] transition-all duration-200`}
      ...
      >
        <div className="box-border content-stretch flex flex-col gap-[24px] items-center w-full pb-[24px] pt-[20px] px-[20px] relative rounded-[inherit]" style={{ overflow: 'visible' }}>
          <motion.div 
            className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full py-[40px]" 
            style={{ overflow: 'visible', margin: '-40px 0' }}
            layout
          ...
          >
            ...
            {!isMultiOutcome && !matchInfo && (
              <motion.div layout className="flex gap-3 w-full">
                <OutcomeButton
                  type="Yes"
              ...
              >
                {(() => {
                  if (!selectedOutcome) {
                    return (
                      <div 
                        className="flex items-center gap-3 p-4 rounded-[12px] h-[82px]"
                        style={{
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Outcome Name */}
                      <p 
                        className="font-sans leading-[24px] not-italic"
                        style={{
                          fontSize: 'var(--text-base)',
                          fontWeight: 'var(--font-weight-semi-bold)',
        ...
        <div 
          aria-hidden="true" 
          className={`absolute border-solid inset-0 pointer-events-none rounded-bl-[12px] rounded-br-[12px] rounded-tr-[12px] ${cardBorderRadius} shadow-[0px_8px_56px_-12px_rgba(0,0,0,0.2)] transition-all duration-200`}
